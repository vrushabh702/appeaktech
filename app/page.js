...
export default function WelcomePage() {
  ...
  return (
    <div>
            ...
            <Col md={12}>
              <div className="technologytabs">
                <Tab.Container id="" defaultActiveKey="frontend">
                  <Row>
                    <Col sm={12}>
                      <Nav variant="pills" className="list gap-30 justify-content-center mt-5 mb-5">
                        <Nav.Item>
                          <Nav.Link eventKey="frontend">
                              <div className="tech">
                                <svg xmlns="http://www.w3.org/2000/svg" width="55" height="55" viewBox="0 0 55 55" fill="none"><rect x="0.600488" y="0.911035" width="53.7003" height="53.5013" rx="26.7507" fill="#021D3D"></rect><rect x="0.600488" y="0.911035" width="53.7003" height="53.5013" rx="26.7507" stroke="#20528D" strokeWidth="0.829882"></rect><g clipPath="url(#clip0_300_953)"><path d="M31.9663 37.6421C31.7475 37.9976 31.3686 38.2085 30.9467 38.2085H23.9545C23.5327 38.2085 23.1538 37.9976 22.935 37.6421C22.7241 37.2944 22.7045 36.8726 22.892 36.5093L23.6186 35.0835H31.2827L32.0092 36.5093C32.1967 36.8726 32.1772 37.2944 31.9663 37.6421Z" fill="white"></path><path d="M27.0601 19.0679H18.4663C18.0348 19.0679 17.6851 19.4176 17.6851 19.8491V23.7554C17.6851 24.1868 18.0348 24.5366 18.4663 24.5366H27.0601C27.4915 24.5366 27.8413 24.1868 27.8413 23.7554V19.8491C27.8413 19.4176 27.4915 19.0679 27.0601 19.0679Z" fill="white"></path><path d="M21.5913 25.3179H18.4663C18.0348 25.3179 17.6851 25.6676 17.6851 26.0991V29.2241C17.6851 29.6556 18.0348 30.0054 18.4663 30.0054H21.5913C22.0228 30.0054 22.3726 29.6556 22.3726 29.2241V26.0991C22.3726 25.6676 22.0228 25.3179 21.5913 25.3179Z" fill="white"></path><path d="M27.0601 25.3179H23.9351C23.5036 25.3179 23.1538 25.6676 23.1538 26.0991V29.2241C23.1538 29.6556 23.5036 30.0054 23.9351 30.0054H27.0601C27.4915 30.0054 27.8413 29.6556 27.8413 29.2241V26.0991C27.8413 25.6676 27.4915 25.3179 27.0601 25.3179Z" fill="white"></path><path d="M36.8257 30.0054H30.9663C30.7515 30.0054 30.5757 29.8296 30.5757 29.6147C30.5757 29.3999 30.7515 29.2241 30.9663 29.2241H36.8257C37.0405 29.2241 37.2163 29.3999 37.2163 29.6147C37.2163 29.8296 37.0405 30.0054 36.8257 30.0054ZM36.8257 28.0522H30.9663C30.7515 28.0522 30.5757 27.8765 30.5757 27.6616C30.5757 27.4468 30.7515 27.271 30.9663 27.271H36.8257C37.0405 27.271 37.2163 27.4468 37.2163 27.6616C37.2163 27.8765 37.0405 28.0522 36.8257 28.0522ZM36.8257 26.0991H30.9663C30.7515 26.0991 30.5757 25.9233 30.5757 25.7085C30.5757 25.4937 30.7515 25.3179 30.9663 25.3179H36.8257C37.0405 25.3179 37.2163 25.4937 37.2163 25.7085C37.2163 25.9233 37.0405 26.0991 36.8257 26.0991Z" fill="white"></path><path d="M37.2163 17.1147H17.6851C16.6069 17.1147 15.7319 17.9897 15.7319 19.0679V32.3491C15.7319 33.4272 16.6069 34.3022 17.6851 34.3022H37.2163C38.2944 34.3022 39.1694 33.4272 39.1694 32.3491V19.0679C39.1694 17.9897 38.2944 17.1147 37.2163 17.1147ZM16.5132 31.1772V19.0679C16.5132 18.4233 17.0405 17.896 17.6851 17.896H28.6226V31.1772H16.5132ZM38.3882 31.1772H29.4038V17.896H37.2163C37.8608 17.896 38.3882 18.4233 38.3882 19.0679V31.1772Z" fill="white"></path><path d="M35.6538 23.3648C35.5718 23.3648 35.4898 23.3375 35.4194 23.2867C35.2476 23.1578 35.2124 22.9117 35.3413 22.7398L36.3374 21.4117L35.3413 20.0836C35.2124 19.9117 35.2476 19.6656 35.4194 19.5367C35.5913 19.4078 35.8374 19.4429 35.9663 19.6148L37.1382 21.1773C37.2437 21.3179 37.2437 21.5054 37.1382 21.6461L35.9663 23.2086C35.8882 23.3101 35.771 23.3648 35.6538 23.3648ZM31.7476 23.3648C31.6304 23.3648 31.5132 23.3101 31.4351 23.2086L30.2632 21.6461C30.2119 21.5787 30.1841 21.4964 30.1841 21.4117C30.1841 21.327 30.2119 21.2447 30.2632 21.1773L31.4351 19.6148C31.564 19.4429 31.8101 19.4078 31.9819 19.5367C32.1538 19.6656 32.189 19.9117 32.0601 20.0836L31.064 21.4117L32.0601 22.7398C32.189 22.9117 32.1538 23.1578 31.9819 23.2867C31.9116 23.3375 31.8296 23.3648 31.7476 23.3648ZM33.3101 23.3648C33.2788 23.3648 33.2476 23.3648 33.2163 23.3531C33.1159 23.3282 33.0294 23.2644 32.976 23.1758C32.9225 23.0871 32.9064 22.9809 32.9312 22.8804L33.7124 19.7554C33.7404 19.6584 33.805 19.576 33.8924 19.5256C33.9799 19.4751 34.0835 19.4604 34.1815 19.4847C34.2795 19.5089 34.3644 19.5702 34.4182 19.6557C34.472 19.7411 34.4907 19.8441 34.4702 19.9429L33.689 23.0679C33.646 23.2476 33.4859 23.3648 33.3101 23.3648Z" fill="white"></path></g><defs><clipPath id="clip0_300_953"><rect width="25" height="25" fill="white" transform="translate(14.9507 15.1616)"></rect></clipPath></defs></svg>
                                <h6 className="mb-0 text-white fw-semibold mt-3 line-height">Front End <br/>Development</h6>
                              </div>
                          </Nav.Link>
                        </Nav.Item>
                        <Nav.Item>
                      ...
                      <Tab.Content>
                        <Tab.Pane eventKey="frontend">
                          <div className="techlist mt-3">
                            <div className="text-center">
                              <img src="/media/home/html.webp" alt="html" width="35" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">HTML</p>
                            </div>
                            <div className="text-center">
                              <img src="/media/home/css.webp" alt="css" width="auto" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">CSS</p>
                            </div>
                            <div className="text-center">
                              <img src="/media/home/bootstrap.webp" alt="bootstrap" width="auto" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">Bootstrap</p>
                            </div>
                            <div className="text-center">
                              <img src="/media/home/js.webp" alt="Javascript" width="auto" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">Javascript</p>
                            </div>
                            <div className="text-center">
                              <img src="/media/home/angular.webp" alt="angular" width="auto" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">Angular</p>
                            </div>
                            <div className="text-center">
                              <img src="/media/home/reactjs.webp" alt="reactjs" width="auto" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">React JS</p>
                            </div>
                            <div className="text-center">
                              <img src="/media/home/view-js.webp" alt="view-js" width="auto" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">View JS</p>
                            </div>
                          </div>
                        </Tab.Pane>
                        <Tab.Pane eventKey="backend">
                            <div className="techlist mt-3">
                            <div className="text-center">
                              <img src="/media/home/php.webp" alt="php" width="35" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">PHP</p>
                            </div>
                            <div className="text-center">
                              <img src="/media/home/laravel.webp" alt="laravel" width="auto" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">Laravel</p>
                            </div>
                            <div className="text-center">
                              <img src="/media/home/Python.webp" alt="Python" width="auto" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">Python</p>
                            </div>
                            <div className="text-center">
                              <img src="/media/home/mn.webp" alt="Microsoft.net" width="auto" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">MVC.Net</p>
                            </div>
                            <div className="text-center">
                              <img src="/media/home/node.webp" alt="node" width="auto" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">Node JS</p>
                            </div>
                            <div className="text-center">
                              <img src="/media/home/newrubyrails.webp" alt="newrubyrails" width="auto" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">Ruby On Rails</p>
                            </div>
                        ...
                        <Tab.Pane eventKey="ecommerce">
                            <div className="techlist mt-3">
                            <div className="text-center">
                              <img src="/media/home/magento.webp" alt="magento" width="35" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">Magento</p>
                            </div>
                            <div className="text-center">
                              <img src="/media/home/shopfiy.webp" alt="shopfiy" width="auto" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">Shopfiy</p>
                            </div>
                            <div className="text-center">
                              <img src="/media/home/woo.webp" alt="woo-commerce" width="auto" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">WooCommerce</p>
                            </div>
                            <div className="text-center">
                              <img src="/media/home/wordpress.webp" alt="wordpress" width="auto" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">Wordpress</p>
                            </div>
                            <div className="text-center">
                              <img src="/media/home/BigCommerce.webp" alt="BigCommerce" width="auto" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">BigCommerce</p>
                            </div>
                            <div className="text-center">
                              <img src="/media/home/Joomla.webp" alt="Joomla" width="auto" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">Joomla</p>
                            </div>
                            <div className="text-center">
                              <img src="/media/home/Drupal.webp" alt="Drupal" width="auto" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">Drupal</p>
                            </div>
                            <div className="text-center">
                              <img src="/media/home/Moodle.webp" alt="Moodle" width="auto" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">Moodle</p>
                            </div>
                          </div>
                        </Tab.Pane>
                        <Tab.Pane eventKey="mobilleapp">
                          <div className="techlist mt-3">
                            <div className="text-center">
                              <img src="/media/home/ios.webp" alt="ios" width="35" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">IOS</p>
                            </div>
                            <div className="text-center">
                              <img src="/media/home/Android.webp" alt="Android" width="auto" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">Android</p>
                            </div>
                            <div className="text-center">
                              <img src="/media/home/flutter.webp" alt="flutter" width="auto" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">Flutter</p>
                            </div>
                            <div className="text-center">
                              <img src="/media/home/reactjs.webp" alt="react native" width="auto" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">React Native</p>
                            </div>
                            <div className="text-center">
                              <img src="/media/home/Kotlin.webp" alt="Kotlin" width="auto" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">Kotlin</p>
                            </div>
                            <div className="text-center">
                              <img src="/media/home/Swift.webp" alt="Swift" width="auto" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">Swift</p>
                            </div>
                            <div className="text-center">
                              <img src="/media/home/IONIC.webp" alt="IONIC" width="auto" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">IONIC</p>
                            </div>
                          </div>
                        </Tab.Pane>
                        <Tab.Pane eventKey="database">
                          <div className="techlist mt-3">
                            <div className="text-center">
                              <img src="/media/home/mysql.webp" alt="mysql" width="35" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">MYSQL</p>
                            </div>
                            <div className="text-center">
                              <img src="/media/home/Sql.webp" alt="Sql" width="auto" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">SQL</p>
                            </div>
                            <div className="text-center">
                              <img src="/media/home/Postgre.webp" alt="Postgre SOL" width="auto" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">Postgre SOL</p>
                            </div>
                            <div className="text-center">
                              <img src="/media/home/MongoDB.webp" alt="MongoDB" width="auto" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">MongoDB</p>
                            </div>
                            <div className="text-center">
                              <img src="/media/home/SQLite.webp" alt="SQlLite" width="auto" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">SQL-LITE</p>
                            </div>
                            <div className="text-center">
                              <img src="/media/home/Firebase.webp" alt="Firebase" width="auto" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">Firebase</p>
                            </div>
                            <div className="text-center">
                              <img src="/media/home/Snowflake.webp" alt="Snowflake" width="auto" height="35"></img>
                              <p className="text-white mb-0 fw-semibold mt-3">Snowflake</p>
                            </div>
                          </div>
                        </Tab.Pane>
                      </Tab.Content>
      ...
      <section className="footer serviceBg bgImage desktop-padding-100 position-relative">
        <Container>
          <Row>
            <Col md={8}>
              ...
              <div className="locationBox">
                <div className="box darkBlue rounded-10">
      ...
      <section className="footerLast darkBlue desktop-padding-100 position-relative">
        <Container>
          <Row>
            <Col md={3}>
